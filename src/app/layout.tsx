...
export const metadata: Metadata = {
  title: "AutoDealer Pro - Premium Car Dealership",
  description: "Discover quality vehicles with transparent pricing and exceptional service. Find your perfect car today at AutoDealer Pro.",
  keywords: "car dealership, used cars, new cars, automotive, vehicle sales, car financing",
  metadataBase: new URL("https://autodealer-pro.com"),
  alternates: {
    canonical: "https://autodealer-pro.com"
  },
  openGraph: {
    title: "AutoDealer Pro - Premium Car Dealership",
    description: "Discover quality vehicles with transparent pricing and exceptional service.",
